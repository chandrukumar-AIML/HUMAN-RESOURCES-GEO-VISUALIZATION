...
def visualize_point_map(data_frame, selected_state, selected_district):
    ...
    folium_map.save('map.html')#save the map
    st.components.v1.html(open('map.html', 'r', encoding='utf-8').read(), width=900, height=500)#display the map
